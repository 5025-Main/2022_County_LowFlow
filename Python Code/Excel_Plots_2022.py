...
#######################################
    ...
    chart_full.set_x_axis({'position_axis':'on_tick','date_axis':True,'min':xmin,'max':xmax})#,'num_font':{'rotation':90},'num_format':'mm/dd/yyyy'})
    ...
    chart_full.set_y2_axis({'name':'Rainfall (inches)','min':0.0,'max':np.round(rain_max,1),'reverse':True})
    chart_full.set_x2_axis({'date_axis':True,'min':xmin,'max':xmax})
...
####################################################################################
    ...
    # Configure the chart axes.
    chart_low.set_x_axis({'position_axis':'on_tick','date_axis':True,'min':xmin,'max':xmax,'num_font':{'rotation':90},'num_format':'mm/dd/yyyy'})
    ...
    rain_max = rain_1D.max()*1.5
    chart_low.set_y2_axis({'name':'Rainfall (inches)','min':0.0,'max':np.round(rain_max,1),'reverse':True})
    chart_low.set_x2_axis({'date_axis':True,'min':xmin,'max':xmax})
